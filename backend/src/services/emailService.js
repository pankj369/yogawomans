...
class EmailService {
  ...
  async sendWelcomeEmail(email, userName) {
    const subject = "Welcome to YogaWomans — Your AI Wellness Journey Begins 🧘✨";
    const body = `
Dear ${userName || "Yogi"},

Welcome to YogaWomans, your premium AI Wellness Operating System! 
...
We noticed you left some organic wellness items in your YogaWomans cart. 
...
Return to cart: https://yogawomans.com/store
...
The YogaWomans Team
  ...
  async sendPremiumUpgradeEmail(email, userName) {
    const subject = "Welcome to YogaWomans Pro — Access Unlimited Healing 👑🧘";
    const body = `
Dear ${userName || "Yogi"},

Congratulations! You are now a YogaWomans Pro Member.
